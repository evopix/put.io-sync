...
var PutIOSync = function (opts) {
     ...
     * @type {string}
     */
    var downloadTempDir = ".putiosync-downloading";
        ...
        ensureDir(parent, undefined, function (err) {
            ...
            request({
                ...
                if (response.statusCode === 302) {
                    ...
                    var tempFilename = path.join(path.join(sync.local_path, downloadTempDir), fileData.id + "-" + path.basename(target));
    ...
    this.startSync = function () {
        ...
        _.each(config.sync, function (sync) {
            ...
            var tempDir = path.join(sync.local_path, downloadTempDir);
